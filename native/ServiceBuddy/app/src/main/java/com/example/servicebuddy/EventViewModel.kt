...
class EventViewModel : ViewModel() {
    ...
    init {
        // Încarcă date demonstrative
        loadDemoData()
    }

    // Funcție ajutătoare pentru a converti textul în Dată
    ...
    // READ (Obține un singur eveniment)
